...
import de.castcrafter.travel_anchors.setup.ModItemGroups;
...
@Mod.EventBusSubscriber(modid = TravelAnchors.MOD_ID, bus = Mod.EventBusSubscriber.Bus.MOD)
public class ModEventSubscriber {

    private static final Logger LOGGER = LogManager.getLogger(TravelAnchors.MOD_ID + " Mod Event Subscriber");
