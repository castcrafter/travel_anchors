...
public class BakedModel implements IDynamicBakedModel {
    ...
    public static final ResourceLocation TEXTURE = new ResourceLocation(TravelAnchors.MODID, "block/travel_anchor_port");
    ...
    public List<BakedQuad> getQuads(@Nullable BlockState state, @Nullable Direction side, @Nonnull Random rand, @Nonnull IModelData extraData) {
        ...
        BlockState mimic = extraData.getData(TravelAnchorTile.MIMIC);
        if (mimic != null && !(mimic.getBlock() instanceof TravelAnchorBlock)) {
